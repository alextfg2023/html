    ...
    if(isset($_POST['guardar'])){
        ...
        if(count($campos) > 0){
            ...
            foreach ($tablas as $index => $tabla) {
                ...
                if (isset($_POST['tablas_seleccionadas']) && in_array($semanaTabla, $_POST['tablas_seleccionadas'])) {
                    $insert_tablas = mysqli_query($conn, "INSERT INTO tablas (nombre, id_usuario, horario, semana) VALUES ('$nombreTabla', '$id', '$horario', '$semanaTabla')") or die($conn->error);
